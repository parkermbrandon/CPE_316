...
static volatile int32_t *inBufferPtr;
static volatile int32_t *outBufferPtr = dacData;
...
//void processData() {
//	static float dataIn, dataOut;
//
//	for (uint8_t n = 0; n < (BUFFER_SIZE/2) - 1; n++) {
//
//		// Get ADC input and convert to float
//		dataIn = INT16_TO_FLOAT * inBufferPtr[n];
//		if(dataIn < 1.0f) {
//			dataIn -= 2.0f;
//		}
//
//		// Compute new output sample
//		outBufferPtr[n] = (int16_t) (FLOAT_TO_INT * dataOut);
//	}
//
//	dataReadyFlag = 0;
//}
...
//void processData() {
//	// Example: Transmit first few data values from the buffer
//	  char buffer[50];
//	  for (int i = 0; i < 10; i++) { // Adjust the number of samples as needed
//	    snprintf(buffer, sizeof(buffer), "Data[%d]: %d\r\n", i, adcData[i]);
//	    HAL_UART_Transmit(&huart2, (uint8_t*)buffer, strlen(buffer), 1000);
//	    HAL_Delay(10); // Short delay to prevent UART buffer overrun
//	  }
//
...
//  //HAL_StatusTypeDef txStatus = HAL_SAI_Transmit_DMA(&hsai_BlockA2, (uint8_t *)dacData, BUFFER_SIZE);
//
//
...
//	    if (dataReadyFlag == 1)
//	    {
//	      processData(); // Call processData function when data is ready
